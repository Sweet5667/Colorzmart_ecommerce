...
from .models import User,Admin_page
...
class CustomUserForm(UserCreationForm):
	...
	password2=forms.CharField(widget=forms.PasswordInput(attrs={'class':'form-control','placeholder':'Confirm Password','type':'password'}))
